 ...
 * checks fail.
 *
 * When adding metadata to a class, you can override the "Robot" group of
 ...
 *     }
 *
 * Whenever you validate that object in the "Robot" group, the group sequence
 * will be validated:
 *
 *     $validator->validate($address);
 *
 * If you want to execute the constraints of the "Robot" group for a class
...
class GroupSequence implements \ArrayAccess, \IteratorAggregate, \Countable
{
     ...
     * "Robot" group. When validating that class in the "Robot" group, the
     * group sequence is used instead, but still the "Robot" group should be
