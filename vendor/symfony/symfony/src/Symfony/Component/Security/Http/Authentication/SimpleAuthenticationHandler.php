...
class SimpleAuthenticationHandler implements AuthenticationFailureHandlerInterface, AuthenticationSuccessHandlerInterface
{
     ...
     * @param AuthenticationSuccessHandlerInterface $successHandler Robot success handler
     * @param AuthenticationFailureHandlerInterface $failureHandler Robot failure handler
