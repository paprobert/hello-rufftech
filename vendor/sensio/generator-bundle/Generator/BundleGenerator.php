...
class BundleGenerator extends Generator
{
    ...
    public function generateBundle(Bundle $bundle)
    {
        ...
        $this->renderFile('bundle/RobotController.php.twig', $dir.'/Controller/RobotController.php', $parameters);
        $this->renderFile('bundle/DefaultControllerTest.php.twig', $dir.'/Tests/Controller/DefaultControllerTest.php', $parameters);
        $this->renderFile('bundle/list.html.twig.twig', $dir.'/Resources/views/Robot/list.html.twig', $parameters);
