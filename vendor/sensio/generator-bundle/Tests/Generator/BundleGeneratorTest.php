...
class BundleGeneratorTest extends GeneratorTest
{
    public function testGenerateYaml()
    {
        ...
        $files = array(
            'FooBarBundle.php',
            'Controller/RobotController.php',
            'Resources/views/Robot/list.html.twig',
        ...
        $content = file_get_contents($this->tmpDir.'/Foo/BarBundle/Controller/RobotController.php');
        $this->assertContains('public function indexAction', $content);
        $this->assertNotContains('@Route("/hello/{name}"', $content);

        $content = file_get_contents($this->tmpDir.'/Foo/BarBundle/Resources/views/Robot/list.html.twig');
