...
class TemplateGuesserTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGuessTemplateName()
    {
        ...
        $this->assertEquals('FooBundle:Foo:list.html.twig', (string) $templateReference);
    }
    ...
    public function testGuessTemplateNameWithParentBundle()
    {
        ...
        $this->assertEquals('FooBundle:Bar:list.html.twig', (string) $templateReference);
    }
    ...
    public function testGuessTemplateNameWithCascadingParentBundle()
    {
        ...
        $this->assertEquals('FooBundle:FooBar:list.html.twig', (string) $templateReference);
    }
    ...
    public function testGuessTemplateWithoutBundle()
    {
        ...
        $this->assertEquals(':OutOfBundle:list.html.twig', (string) $templateReference);
    }
